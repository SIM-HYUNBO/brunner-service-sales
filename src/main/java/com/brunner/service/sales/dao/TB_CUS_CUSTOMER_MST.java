...
public class TB_CUS_CUSTOMER_MST {
	private static final Logger logger = Logger.getLogger(TB_CUS_CUSTOMER_MST.class.getName());
	...
	public static int insert_01(
 		...
 		String sqlId = "insert_TB_CUS_CUSTOMER_MST_01";
 		int nEffected = 0;
	...
	public static int update_01(
 		...
 		String sqlId = "update_TB_CUS_CUSTOMER_MST_01";
 		int nEffected = 0;
 		HashMap<String, Object> params = new HashMap<String, Object>();
 		params.put("salesType", salesType);
 		params.put("salesCategory", salesCategory);
	...
	public static int update_02(
 		...
 		String sqlId = "update_TB_CUS_CUSTOMER_MST_02";
 		int nEffected = 0;
 		HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("systemCode", systemCode);
		params.put("userId", userId);
	...
	public static List<HashMap<String, Object>> select_01(
		...
		List<HashMap<String, Object>> ret = null;
 		String sqlId = "select_TB_CUS_CUSTOMER_MST_01";
 		HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("systemCode", systemCode);
		params.put("userId", userId);
	...
	public static List<HashMap<String, Object>> select_02(
		...
		List<HashMap<String, Object>> ret = null;
 		String sqlId = "select_TB_CUS_CUSTOMER_MST_02";
 		HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("systemCode", systemCode);
		params.put("userId", userId);
		params.put("customerId", customerId);
